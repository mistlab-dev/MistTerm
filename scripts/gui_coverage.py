...
GUI_FEATURES: dict[str, tuple[str, str]] = {
    ...
    "tab.new": ("新建标签 Ctrl+Shift+T", "smoke|workflow|e2e"),
    ...
    "terminal.pane_focus": ("窗格切换 Ctrl+Shift+←/→", "smoke|workflow"),
    "terminal.shell_ctrl_c": ("终端 Ctrl+C 中断（不关标签）", "smoke"),
    "terminal.shell_ctrl_w": ("终端 Ctrl+W 删词（不关标签）", "smoke"),
    "terminal.copy_shortcut": ("终端复制选区 Ctrl+Shift+C", "smoke"),
    "terminal.paste_shortcut": ("终端粘贴 Ctrl+Shift+V", "smoke"),
    "terminal.tab_enter": ("终端 Tab/Enter 焦点", "smoke"),
